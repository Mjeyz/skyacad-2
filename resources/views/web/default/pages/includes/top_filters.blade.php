<div id="topFilters" class=" p-10 p-md-20">
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 d-block d-md-flex align-items-center justify-content-end my-25 my-lg-0">
            <div class="filter-up-buttons-active d-flex align-items-center justify-content-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
                <label class="mb-0 mr-10 cursor-pointer" for="upcoming">All</label>
            ...
            <div class="filter-up-buttons d-flex align-items-center justify-content-between justify-content-md-center">
                <label class="mb-0 mr-10 cursor-pointer" for="free">Maintenance</label>
                <div class="custom-control custom-switch">
            ...
            <div class="filter-up-buttons d-flex align-items-center justify-content-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
                <label class="mb-0 mr-10 cursor-pointer" for="discount">Safety</label>
                <div class="custom-control custom-switch">
            ...
            <div class="filter-up-buttons d-flex align-items-center justify-content-between justify-content-md-center">
                <label class="mb-0 mr-10 cursor-pointer" for="download">English</label>
                <div class="custom-control custom-switch">
